                            ...
                            @foreach($product as $item)
                                <div class="container-fluid">
                                    <tr>
                                        ...
                                        <td class="col-md-7"><img src="/media/product-slider/{!! $item->image!!}" alt="" width="400px"></td>
                                    ...
                                    <tr>
                                        <td class="col-md-3">
                                            ...
                                            {{--Edit--}}
                                            <a title="Edit article" href="{{ url('adm/pslider/'.$item->id.'/edit') }}"
...
{{--//form--}}
            <div class="container">
                ...
                <div class="col-md-10">
                    <div class="input-group ">
                        {!! Form::open(['route'=>'pslider.store','files' => true]) !!}
                        {{ csrf_field() }}
    ...
    @foreach($product as $item)
        <div class="modal fade" id="delete_article_{{ $item->id  }}" tabindex="-1" role="dialog"
            ...
            <form class="" action="{{ route('pslider.destroy', ['id' => $item->id]) }}" method="post">
