<div class="container-fluid">
    <div class="row">
        ...
        <link rel='stylesheet' href='{{asset('mysite/product-slider/css/font-awesome.css')}}' type='text/css' media='all'/>
        ...
        <div id="slider-flexslider" class="slider flexslider" style="width: 1200px; height: 400px;">
            <ul class="slides">
                ...
                <li>
                    <img src="/media/product-slider/{{$item->image}}" alt="0018" title="0018"/>
                    <div class="slider-caption caption-right">
                        ...
                        <span class="special-font" style="font-size:24px;">
				                <span style="font-size: 40px;">Грн{!! $item->price !!}</span></span>
                    </div>
                </li>
                @endforeach
            </ul>
